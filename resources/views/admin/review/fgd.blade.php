...
@include('admin.partials.page-header', [
    'title' => 'Review FGD',
    'subtitle' => 'Review catatan FGD peserta',
    'actions' => '<a href="' . route('admin.dashboard') . '" class="admin-btn-secondary">← Kembali ke Dashboard</a>',
        ...
        <div class="admin-card overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-primary">Daftar Catatan FGD</h3>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="fgdTableBody">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-primary">Belum ada catatan FGD</h3>
                                <p class="mt-1 text-sm text-tertiary">Catatan FGD akan muncul di sini setelah peserta mengumpulkan</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-primary">Detail Catatan FGD</h3>
