    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Review Roleplay</h1>
                    <p class="text-sm text-gray-600">Review catatan roleplay peserta</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Daftar Catatan Roleplay</h3>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="roleplayTableBody">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada catatan roleplay</h3>
                                <p class="mt-1 text-sm text-gray-500">Catatan roleplay akan muncul di sini setelah peserta mengumpulkan</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-gray-900">Detail Catatan Roleplay</h3>
