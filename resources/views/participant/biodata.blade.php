            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                        ...
                        <p class="text-gray-400 text-sm">PIN: {{ $participant->pin }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->birth_place ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->birth_date ? $participant->birth_date->format('d F Y') : 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->gender_text ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->home_address ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->phone_number ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->email ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->institution ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->current_position ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 cyber-border">
                                <p class="text-white">{{ $participant->grade ?: 'Tidak diisi' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
